...
<tr><td ><h2>新闻标题:</h2></td></tr><tr><td><input type="text" name="title" size=80/></td></tr><tr>
<td ><h2>新闻内容:</h2></td></tr><tr><td><textarea class="ckeditor" cols="80" id="editor1" name="content" rows="8"> </textarea> </td></tr><tr>
