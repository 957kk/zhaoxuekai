...
<%@page import="com.zhaoxk_job.entity.Notice,java.util.ArrayList,java.util.*" %>
...
<div align="center">
	...
	<table border="1" class="table_list">
		<tr class="td_list">
			...
			<th width="200px">发布号</th><th>发布人</th>
			<th>标题</th><th>内容</th>
			<th>上传时间</th><th>编辑</th>
