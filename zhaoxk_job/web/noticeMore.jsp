...
<s:bean id="pageBean" name="com.zhaoxk_job.bean.PageBean"  />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<h1 align="center">更多通知</h1>
				...
				<table style="width: 800px;" class="table_list">
				 ...
				 当前是第<s:property value="#request.pageBean.page"/>页/(总共
	        <s:property value="#request.pageBean.totalPage"/>)页/总记录数是
